    ...
    <div className="app">
      ...
      <section id="contact" className="contact">
            <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.6 }}
                className="contact-container-simple"
            >
                <h2 className="section-title">Get In Touch</h2>
                <p className="contact-text">Have a question or want to collaborate? We'd love to hear from you.</p>

                <a href="mailto:contact@ksi-production.com" className="btn btn-primary btn-email">
      ...
      <footer className="footer">
        <div className="footer-content">
          ...
          <p className="copyright">© 2025 KSI Production. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
